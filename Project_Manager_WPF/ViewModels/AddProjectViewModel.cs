    ...
    IServiceProvider serviceProvider) : ObservableObject
{
    ...
    public async Task AddProject()
    {
        ...
        if (success)
        {
            ...
            var projectListVM = _serviceProvider.GetRequiredService<ProjectListViewModel>();

            // Refresh list method generated by ChatGPT
            await projectListVM.GetProjectsAsync();

            mainViewModel.CurrentViewModel = projectListVM;
        }
    }
